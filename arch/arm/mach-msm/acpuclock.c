...
/*Keep axi bus on 160MHz */
    ...
    */
    ...
    /*if( (g_acpuclock_hwid == CMCS_HW_EVB1) || (g_acpuclock_hwid == CMCS_ORIG_RTP_PR1) || (g_acpuclock_hwid == CMCS_ORIG_CTP_PR1) ||
        (g_acpuclock_hwid == CMCS_850_RTP_PR2) || (g_acpuclock_hwid == CMCS_850_RTP_PR3) || (g_acpuclock_hwid == CMCS_850_RTP_MP1) ||
        (g_acpuclock_hwid == CMCS_900_RTP_PR2) || (g_acpuclock_hwid == CMCS_900_RTP_PR3) || (g_acpuclock_hwid == CMCS_900_RTP_MP1) ||        
        (g_acpuclock_hwid == CMCS_850_CTP_PR2) || (g_acpuclock_hwid == CMCS_850_CTP_PR3) ||
        (g_acpuclock_hwid == CMCS_900_CTP_PR2) || (g_acpuclock_hwid == CMCS_900_CTP_PR3) ||
        (g_acpuclock_hwid == CMCS_145_CTP_PR1) ||
        (g_acpuclock_hwid == CMCS_125_FST_PR1) || (g_acpuclock_hwid == CMCS_125_FST_PR2) || (g_acpuclock_hwid == CMCS_125_FST_MP1) ||
        (g_acpuclock_hwid == CMCS_CTP_F917_PR1) ||
        (g_acpuclock_hwid == CMCS_125_CTP_GRE_PR1) )
    {
        degrade_freq_flag = 1;
