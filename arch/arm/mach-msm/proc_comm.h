...
void proc_comm_write_PID_testFlag( unsigned int oem_cmd,unsigned* data );
//Added for new touch calibration by Stanley++
int proc_comm_read_nv(unsigned *cmd_parameter);
int proc_comm_write_nv(unsigned *cmd_parameter);
//Added for new touch calibration by Stanley--
...
//FIH, WillChen, 2009/6/3++
/* [FXX_CR], Add For ALS read ADC value*/
int proc_comm_read_adc(unsigned *cmd_parameter);
...
void proc_comm_write_FUSE( unsigned int oem_cmd);
void proc_comm_read_FUSE( unsigned int oem_cmd,unsigned* data );
//FIH,NeoChen, for read&write FUSE,20100727 --
